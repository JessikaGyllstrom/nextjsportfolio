    ...
    <div id="skills" className="flex justify-center w-screen">
      <XaxisAnimate>
        <div className="flex justify-center w-screen">
          ...
          {skills.map((skill, id) => 
              <div key={id} className='h-full w-full md:w-1/2 flex flex-col m-3 border border-gray-700 rounded-sm  bg-gray-800 bg-opacity-20 hover:scale-[1.02] transition ease-in-out delay-850'>
